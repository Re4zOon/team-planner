...
- **Team Member Management**: Add team members with customizable attributes:
  - **Availability (%)**: Percentage of time available for project work
  - **Effectiveness (%)**: Effectiveness multiplier (e.g., 75% for junior developers)
  - **General Maintenance (%)**: Time spent on general maintenance tasks
...
- **Junior Developer**: 
  ...
  - General Maintenance: 20% (spends time on support tickets)
  
- **Senior Developer with Part-Time Availability**:
  - Availability: 50% (working part-time)
  - Effectiveness: 100%
  - General Maintenance: 50% (handles most maintenance work)
